...
\begin{tehtava}
	...
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$3x^2-6x$}
			\alakohta{$4x^3-2x+3$}
			\alakohta{$10x^9-9x^8-8x^7$}
			\alakohta{$100x^99+50x^49$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{alakohdat}
		\alakohta{$\frac{2x}{x^3+1}$}
		\alakohta{$\frac{x+5}{4x^4+6}$}
		\alakohta{$\frac{2x^2+x}{6x^2+x+1}$}
		\alakohta{$\frac{5x^3+4x}{6x^7}$}
	\end{alakohdat}
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$\frac{-4x^3+2}{x^6+2x^3+1}$}
			\alakohta{$\frac{-6x^4-40x^3+3}{8x^8+24x^4+18}$}
			\alakohta{$\frac{-4x^2+4x+1}{36x^4+12x^3+13x^2+2x+1}$}
			\alakohta{$\frac{-10x^2-12}{3x^7}$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava} % pohjustaa MAA10:tä
	Minkä funktion derivaattafunktio on kyseessä?
	\begin{alakohdat}
		\alakohta{$4x^2$}
		\alakohta{$6x^3+5x$}
		\alakohta{$\frac1{x^2}$}
		\alakohta{$\frac5{x^2+4x+4}$}
	\end{alakohdat}
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$\frac43 x^3 + C$}
			\alakohta{$\frac32 x^4 + \frac52 x^2 + C$}
			\alakohta{$\frac{-1}x + C$}
			\alakohta{$\frac{3x+1}{x+2} + C$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
